...
/** Estrategia greedy: elige la pregunta que minimiza el peor caso max(si, no). */
public class EstrategiaMaquina {

    private final RastreadorCandidatos rastreador;
    private final Registro log;

    public EstrategiaMaquina(RastreadorCandidatos rastreador, Registro log) {
        this.rastreador = rastreador;
        this.log = log;
    }

    /** Mejor pregunta, o null si ninguna divide el conjunto. */
